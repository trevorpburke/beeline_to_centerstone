...
df.rename(columns={'Beeline ID': 'Employee ID', 'Date': 'Hire Date', 'Date.1': 'End Date',
                    'Location Name': 'Business Site', 'Hiring Manager': 'Workers Manager',
                    'Department Name': 'Supervisory Org'}, inplace=True)
